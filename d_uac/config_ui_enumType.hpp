...
class Addons__d_uac_EnumType_Edit: Addons__d_uac_BaseValueEditDialog
{
	onUnload = "\
...
//			text = "Addons__d_uac_ED__title";
		...
		class EntriesListBox: RscListBox
		{
			idc = 101;
...
//			SizeEx = HEIGHT_BASE_SIZE * 4.5 / 5.0;
			...
			onMouseButtonUp = "\
					...
					Addons__d_uac_ED__new_val_ind = lbCurSel (_this select 0);\
					closeDialog 0;\
					};\
					false;\
				";
